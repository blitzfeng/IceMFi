...
import com.og.filemanager.SaveAsActivity;
...
public class TestSaveAsActivity extends BaseTestFileManager {
    ...
    public void testIntentSaveAs() {
        onView(ViewMatchers.withHint(com.og.filemanager.R.string.filename_hint)).perform(closeSoftKeyboard(), replaceText("oi-target.txt"));
        onView(ViewMatchers.withHint(com.og.filemanager.R.string.filename_hint)).perform(actionWithAssertions(new ViewAction() {
            @Override
