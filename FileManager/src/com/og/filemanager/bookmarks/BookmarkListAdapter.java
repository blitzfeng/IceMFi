package com.og.filemanager.bookmarks;

import java.io.File;
import java.util.ArrayList;

import com.og.filemanager.ThumbnailLoader;
...
public class BookmarkListAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			convertView = inflater.inflate(com.og.filemanager.R.layout.item_filelist, null);
			
			viewHolder = new ViewHolder();
			viewHolder.icon = (ImageView) convertView.findViewById(com.og.filemanager.R.id.icon);
			viewHolder.primaryInfo = (TextView) convertView.findViewById(com.og.filemanager.R.id.primary_info);
			viewHolder.secondaryInfo = (TextView) convertView.findViewById(com.og.filemanager.R.id.secondary_info);
		...
		if(item.getFile().isDirectory()) {
			viewHolder.icon.setImageResource(com.og.filemanager.R.drawable.ic_launcher_folder);
		}
