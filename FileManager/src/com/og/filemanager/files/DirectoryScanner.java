package com.og.filemanager.files;
...
public class DirectoryScanner extends Thread {
	...
	private void init(){
		...
		sdIcon = context.getResources().getDrawable(com.og.filemanager.R.drawable.ic_launcher_sdcard);
		folderIcon = context.getResources().getDrawable(com.og.filemanager.R.drawable.ic_launcher_folder);
		genericFileIcon = context.getResources().getDrawable(com.og.filemanager.R.drawable.ic_launcher_file);
