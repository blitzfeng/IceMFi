package com.og.filemanager.search;

import java.io.File;
import java.util.HashMap;

import com.og.filemanager.files.FileHolder;
import com.og.filemanager.view.ViewHolder;
...
public class SearchListAdapter extends CursorAdapter {
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		...
		ViewGroup v = (ViewGroup) ((LayoutInflater) context
				...
				com.og.filemanager.R.layout.item_filelist, null);

		// Set the viewholder optimization.
		ViewHolder holder = new ViewHolder();
		holder.icon = (ImageView) v.findViewById(com.og.filemanager.R.id.icon);
		holder.primaryInfo = (TextView) v.findViewById(com.og.filemanager.R.id.primary_info);
		holder.secondaryInfo = (TextView) v.findViewById(com.og.filemanager.R.id.secondary_info);
		v.findViewById(com.og.filemanager.R.id.tertiary_info).setVisibility(View.GONE);
