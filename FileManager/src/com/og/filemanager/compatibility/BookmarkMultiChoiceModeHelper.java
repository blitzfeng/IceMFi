package com.og.filemanager.compatibility;
	...
	public static void listView_setMultiChoiceModeListener(final ListView list, final Context context) {
		list.setMultiChoiceModeListener(new MultiChoiceModeListener() {
			...
			public boolean onCreateActionMode(android.view.ActionMode mode,
					Menu menu) {
				mode.getMenuInflater().inflate(com.og.filemanager.R.menu.bookmarks, menu);
				return true;
			}
			...
			public void onItemCheckedStateChanged(android.view.ActionMode mode,
				...
				mode.setTitle(list.getCheckedItemCount() + " " + context.getResources().getString(com.og.filemanager.R.string.selected));
			}
		});
	}
}