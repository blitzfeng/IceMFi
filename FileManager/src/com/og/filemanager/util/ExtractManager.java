...
public class ExtractManager {
    ...
    private class ExtractTask extends AsyncTask<Object, Void, Integer> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage(context.getResources().getString(com.og.filemanager.R.string.extracting));
            progressDialog.show();
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == ERROR){
                Toast.makeText(context, com.og.filemanager.R.string.extracting_error, Toast.LENGTH_SHORT).show();
            } else if (result == SUCCESS){
                Toast.makeText(context, com.og.filemanager.R.string.extracting_success, Toast.LENGTH_SHORT).show();
            }
