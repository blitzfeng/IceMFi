...
public class CopyHelper {
	...
	private class CopyAsync extends AsyncTask<File, Void, Boolean> {
		...
		protected void onPreExecute() {
			Toast.makeText(mContext, com.og.filemanager.R.string.copying, Toast.LENGTH_SHORT).show();
		}
		...
		protected void onPostExecute(Boolean result) {
			Toast.makeText(mContext, result ? com.og.filemanager.R.string.copied : com.og.filemanager.R.string.copy_error, Toast.LENGTH_SHORT).show();
	...
	private class MoveAsync extends AsyncTask<File, Void, Boolean> {
		@Override
		protected void onPreExecute() {
			Toast.makeText(mContext, com.og.filemanager.R.string.moving, Toast.LENGTH_SHORT).show();
		}
		...
		@Override
		protected void onPostExecute(Boolean result) {
			Toast.makeText(mContext, result ? com.og.filemanager.R.string.moved : com.og.filemanager.R.string.move_error, Toast.LENGTH_SHORT).show();
