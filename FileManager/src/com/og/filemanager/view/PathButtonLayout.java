package com.og.filemanager.view;
...
/**
 * This class handles the displaying of children in {@link PathBar.Mode.STANDARD_INPUT}, including choosing which children to display, how, and where. It automatically uses the {@link PathBar#mCurrentDirectory} field. <b>Note: </b> Never use this with
...
class PathButtonLayout extends LinearLayout implements OnLongClickListener {
	...
	private void init() {
		...
		mPathDrawables.put(Environment.getExternalStorageDirectory().getAbsolutePath(), com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/sdcard", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/mnt/sdcard", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/mnt/sdcard-ext", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/mnt/sdcard0", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/mnt/sdcard1", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/mnt/sdcard2", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/storage/sdcard0", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/storage/sdcard1", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/storage/sdcard2", com.og.filemanager.R.drawable.ic_navbar_sdcard);
		mPathDrawables.put("/", com.og.filemanager.R.drawable.ic_navbar_home);
	}
	...
	private static class PathButtonFactory {
		...
		private static View newButton(File file, final PathBar navbar) {
			...
			if (mPathDrawables.containsKey(file.getAbsolutePath())) {
				...
				((Button) btn).setTextColor(navbar.getResources().getColor(com.og.filemanager.R.color.navbar_details));
