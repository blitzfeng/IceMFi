...
public class SingleDeleteDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		return new AlertDialog.Builder(getActivity())
				...
				.setTitle(getString(com.og.filemanager.R.string.really_delete, mFileHolder.getName()))
	...
	private class RecursiveDeleteTask extends AsyncTask<File, Void, Void> {
		...
		protected void onPreExecute() {		
			dialog.setMessage(getActivity().getString(com.og.filemanager.R.string.deleting));
		...
		protected void onPostExecute(Void result) {
			Toast.makeText(dialog.getContext(), mResult == 0 ? com.og.filemanager.R.string.delete_failure : com.og.filemanager.R.string.delete_success, Toast.LENGTH_LONG).show();
